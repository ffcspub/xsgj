...
- (IBAction)handleBtnClTypeClicked:(id)sender {
    _actionSheet = [[IBActionSheet alloc] initWithTitle:@"选择陈列类型"
                                               delegate:self
    ...
    {
        [_actionSheet addButtonWithTitle:displayType.TYPE_NAME];
    }
...
- (IBAction)handleBtnZcTypeClicked:(id)sender {
    _actionSheet = [[IBActionSheet alloc] initWithTitle:@"选择资产类型"
                                               delegate:self
                                      cancelButtonTitle:@"取消"
                                 destructiveButtonTitle:nil
                                      otherButtonTitles:nil, nil];
    ...
    {
        [_actionSheet addButtonWithTitle:assetType.TYPE_NAME];
    }
